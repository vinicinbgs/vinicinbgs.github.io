...
<h4>
  <a name="create-example"></a>  1.1 Create a file called <ins style={{ color: "red" }}>example.sh</ins> using in terminal this command:
</h4>
...
<h4>
  <a name="write-example"></a> 1.2 Open file <ins style={{ color: "red" }}>example.sh</ins> in your preferred ide
</h4>
...
<h4>
  <a name="run-example"></a> 1.3 Running file <ins style={{ color: "red" }}>example.sh</ins> in terminal
</h4>
