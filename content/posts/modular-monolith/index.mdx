...
# Lessons Learned
- Spend more time defining Module boundaries - it will pay dividends later
- Eventual consistency is great, but you need to plan for it
- Consider merging "chatty" (talk with other frequently) Modules
